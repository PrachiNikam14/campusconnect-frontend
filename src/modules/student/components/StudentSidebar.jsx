...
const StudentSidebar = ({ active, setActive }) => {
  ...
  const menuItems = [
    ...
    // { name: "Upcoming Events", icon: <FaCalendarAlt />, path: "/pages/upcoming-events" }
    // { name: "My Events", icon: <FaClipboardList />, path: "/student/my-events" },
    // { name: "Feedback", icon: <FaCommentDots />, path: "/student/feedback" }
  ];

  const handleClick = (item) => {
    setActive(item.name);   // highlight
